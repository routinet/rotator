 ...
 * @copyright  Copyright (C) 2005 - 2011 Open Source Matters, Inc. All rights
 *             reserved.
 * @author     Kevin Burke
...
<?php /*
<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_rotator&view=blocks'); ?>"
            ...
            <div id="filter-bar" class="btn-toolbar">
                ...
                <div class="filter-search btn-group pull-left">
                    <label for="filter_search"
                           class="element-invisible"><?php echo JText::_('COM_RQUOTE_SEARCH_IN_TITLE'); ?></label>
                    <input type="text" name="filter_search" id="filter_search"
                           placeholder="<?php echo JText::_('COM_RQUOTE_SEARCH_IN_TITLE'); ?>"
                           value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
                           title="<?php echo JText::_('COM_RQUOTE_SEARCH_IN_TITLE'); ?>"/>
                </div>
