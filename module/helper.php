...
function renderRquote(&$rquote, &$params)
	{	
	require(JModuleHelper::getLayoutPath('mod_rquotes','_rquote'));
	}
//---------------------------------------------------------------------------------------------------------------------------------------------------	
...
$query = "SELECT * from	#__rquote WHERE published='1' and catid = $catid";
		$db->setQuery( $query );
...
$xx= count($category);
	...
	$query="SELECT count(*) from #__rquote WHERE published='1' AND catid='$catid'";
	...
	$getQuoteQuery = "SELECT * FROM #__rquote WHERE published='1' AND catid = '$catid' AND daily_number = '$number_reached'";
...
function getTodayRquote($category,$x)
{
	...
	$getQuoteQuery = "SELECT * FROM #__rquote WHERE published='1' AND catid = '$catid' AND daily_number = '$day_today' ";
	$db->setQuery($getQuoteQuery,0);
	$row=$db->loadObjectList();
